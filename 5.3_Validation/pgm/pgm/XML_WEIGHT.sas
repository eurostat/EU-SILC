...
%IF "&EUSILC" = "/ec/acc/0eusilc" OR "&EUSILC" = "/ec/prod/0eusilc" %THEN %DO;  
	...
	PROC IMPORT OUT=POPDEMO DATAFILE="&EUSILC/XLS_CONFIG/Total population.xlsx" DBMS=XLSX REPLACE;
	...
	PROC IMPORT OUT=POP16DEMO DATAFILE="&EUSILC/XLS_CONFIG/popul_16.xlsx" DBMS=XLSX REPLACE;
	...
	PROC IMPORT OUT=HHLFS DATAFILE="&EUSILC/XLS_CONFIG/Nbr of HH.xlsx" DBMS=XLSX REPLACE;
...
TITLE1 "&CC - &YYYY / TRANSMISSION=&SS";
TITLE2 "LOW OUTLIERS OF WEIGHT VARIABLES, LOWER THAN BOUND (5 first obs)";
...
RUN;
TITLE1 "&CC - &YYYY / TRANSMISSION=&SS";
TITLE2 "HIGH OUTLIERS OF WEIGHT VARIABLES, GREATER THAN BOUND = FACTOR * MEDIAN (5 first obs)";
